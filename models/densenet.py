# code in this file is modified from https://github.com/pytorch/vision/blob/master/torchvision/models/densenet.py
import re
import torch
...
def densenet121(num_classes: int, in_channels: int, **kwargs: Any) -> DenseNet:
    ...
    but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet(num_classes, in_channels, 32, (6, 12, 24, 16), 64, **kwargs)